                ...
                <React.Fragment key={i}>
                  ...
                  >
                    <div className="row child-cols col-match justify-between g-4 lg:g-8 xl:g-10">
                      <div className="col-12 sm:col-6 order-1 sm:order-0 lg:order-1">
                        <div className="panel w-90 uc-flex uc-flex-center">
                          {feature.videoSrc ? (
                            <video
                              ...
                              muted
                              playsInline
                              className="rounded-2 w-100 h-auto border"
                            ></video>
                          ) : (
                            <Image
                              src={feature.imgSrc}
                      ...
                      <div className="col-12 sm:col-6 order-0 sm:order-1 lg:order-0">
